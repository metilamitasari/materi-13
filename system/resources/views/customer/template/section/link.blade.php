<link href="https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600,700,800&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('public/css/open-iconic-bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('public/css/bootstrap-datepicker.css')}}">
